 ...
 *
 * @description
 * Faster execution of function.call, static vs dynamic args
 */
export function doCall(handler: Function, context: object, args: Array<any>) {
 ...
 *
 * @description
 * Faster execution of Reflect.construct static vs dynamic args
 */
export function doConstruct<T>(Class: Type<T>, args: Array<any>): T {
  const len = args.length;
  if (len === 7) {
