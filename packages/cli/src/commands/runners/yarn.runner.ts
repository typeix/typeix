...
export class YarnRunner extends AbstractPackageRunner {
  ...
  public async add(dependencies: string, args = ""): Promise<Buffer> {
    return await super.pkgProgress("add " + args, dependencies);
  }

  public async update(dependencies: string, args = ""): Promise<Buffer> {
    return await super.pkgProgress("upgrade " + args, dependencies);
  }

  public async delete(dependencies: string, args = ""): Promise<Buffer> {
    return await super.pkgProgress("remove " + args, dependencies);
  }
