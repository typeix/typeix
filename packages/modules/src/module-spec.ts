...
describe("@Module", () => {
  ...
  test("no imports exports", () => {
    ...
    let injector: ModuleInjector = ModuleInjector.createAndResolve(ApplicationModule, []);
  ...
  test("shared providers", () => {
    ...
    let injector: ModuleInjector = ModuleInjector.createAndResolve(ApplicationModuleA, [ {provide: CService, useValue: cInstance} ]);
